...
import com.eja.realmcrud.adapter.DataAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    ArrayList<ModelSiswa> modelSiswa = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recycler.setAdapter(new DataAdapter(MainActivity.this, modelSiswa));
    ...
    private void setData(){
        modelSiswa = helper.tampilDataSiswa();
        if (modelSiswa.size() == 0){
